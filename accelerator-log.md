...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=seletreby&repo=hungry",
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=seletreby&repo=hungry","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"dev","cacheType":"inmemCache","enableRabbitMQBroker":true}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input1936510578309208785, --data-values-file, /tmp/accelerator-options14795552655130749967.json, --output-files, /tmp/ytt-output5109614016121035363]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=seletreby&repo=hungry'
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=seletreby&repo=hungry","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"dev","cacheType":"inmemCache","enableRabbitMQBroker":true}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input2711640775375024135, --data-values-file, /tmp/accelerator-options5032094389917331319.json, --output-files, /tmp/ytt-output12639848593133875164]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=seletreby&repo=hungry","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"dev","cacheType":"inmemCache","enableRabbitMQBroker":true}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input15944605278597712296, --data-values-file, /tmp/accelerator-options6127090538519445528.json, --output-files, /tmp/ytt-output2406302928273235298]
